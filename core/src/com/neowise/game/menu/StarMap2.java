...
public class StarMap2 extends GameLevelObject implements InputProcessor {
    ...
    private float cameraPanSpeed, camYPos;

    public Color bgColor = new Color(0.01f,0.01f,0.02f,1);

    public StarMap2(final NeoWiseGame game) {
